...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{images/rstudio_9} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{images/rstudio_4} \end{center}
