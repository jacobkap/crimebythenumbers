...
I am available to be hired as a consultant. If you want to hire me as a consultant for data work or on a research project, send me an email (at \href{mailto:jacob@crimedatatool.com}{\nolinkurl{jacob@crimedatatool.com}}) describing the project, what I would do on the project, how long you expect it to take and who else is involved in the project. My standard consulting fee differs depending on what type of organization is hiring me. For non-profits, it is \$75 an hour. For government or universities, it is \$100 an hour. For the private sector, it is \$140 an hour. Depending on the specific project these rates may change.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{colorado \textless{}{-}}\StringTok{ }\NormalTok{offenses\_known\_yearly\_}\DecValTok{1960}\NormalTok{\_}\DecValTok{2017}\NormalTok{[offenses\_known\_yearly\_}\DecValTok{1960}\NormalTok{\_}\DecValTok{2017}\OperatorTok{$}\NormalTok{state }\OperatorTok{==}\StringTok{ "colorado"}\NormalTok{, ]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{colorado \textless{}{-}}\StringTok{ }\NormalTok{colorado[colorado}\OperatorTok{$}\NormalTok{year }\OperatorTok{\%in\%}\StringTok{ }\DecValTok{2011}\OperatorTok{:}\DecValTok{2017}\NormalTok{, ]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ucr2017\_big\_cities \textless{}{-}}\StringTok{ }\NormalTok{ucr2017[ucr2017}\OperatorTok{$}\NormalTok{population }\OperatorTok{\textgreater{}}\StringTok{ }\DecValTok{1000000}\NormalTok{, ]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{colorado\_agg}\OperatorTok{$}\NormalTok{murder\_rate \textless{}{-}}\StringTok{ }\NormalTok{colorado\_agg}\OperatorTok{$}\NormalTok{actual\_murder }\OperatorTok{/}\StringTok{ }\NormalTok{colorado\_agg}\OperatorTok{$}\NormalTok{population }\OperatorTok{*}\StringTok{ }\DecValTok{100000}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{penn\_alcohol \textless{}{-}}\StringTok{ }\NormalTok{alcohol[alcohol}\OperatorTok{$}\NormalTok{state }\OperatorTok{==}\StringTok{ "pennsylvania"}\NormalTok{, ]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{penn\_alcohol}\OperatorTok{$}\NormalTok{year \textless{}{-}}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(penn\_alcohol}\OperatorTok{$}\NormalTok{year)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{} [1] 5763}
\KeywordTok{ncol}\NormalTok{(shootings)}
\CommentTok{\#\textgreater{} [1] 17}
\end{Highlighting}
\end{Shaded}

The data has 17 variables and covers 5763 shootings. Let's check out some of the variables, first using \texttt{head()} then using \texttt{summary()} and \texttt{table()}.
...
\CommentTok{\#\textgreater{} "2015{-}01{-}02" "2016{-}06{-}15" "2017{-}12{-}10" "2017{-}12{-}01" "2019{-}05{-}28" "2020{-}11{-}09"}
...
\CommentTok{\#\textgreater{}    6.00   27.00   35.00   37.14   46.00   91.00     265}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{}             5472              291}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{}             shot shot and Tasered }
\CommentTok{\#\textgreater{}        94.950547         5.049453}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{}                       0.01735207                       0.01735207 }
\CommentTok{\#\textgreater{}                   Airsoft pistol                               ax }
\CommentTok{\#\textgreater{}                       0.05205622                       0.41644977 }
\CommentTok{\#\textgreater{}                         barstool                     baseball bat }
\CommentTok{\#\textgreater{}                       0.01735207                       0.32968940 }
\CommentTok{\#\textgreater{}          baseball bat and bottle baseball bat and fireplace poker }
\CommentTok{\#\textgreater{}                       0.01735207                       0.01735207 }
\CommentTok{\#\textgreater{}           baseball bat and knife                            baton }
\CommentTok{\#\textgreater{}                       0.01735207                       0.10411244 }
\CommentTok{\#\textgreater{}                          bayonet                           BB gun }
\CommentTok{\#\textgreater{}                       0.01735207                       0.08676037 }
\CommentTok{\#\textgreater{}               BB gun and vehicle                     bean{-}bag gun }
\CommentTok{\#\textgreater{}                       0.01735207                       0.01735207 }
\CommentTok{\#\textgreater{}                      beer bottle                     blunt object }
\CommentTok{\#\textgreater{}                       0.05205622                       0.08676037 }
\CommentTok{\#\textgreater{}                           bottle                    bow and arrow }
\CommentTok{\#\textgreater{}                       0.01735207                       0.01735207 }
\CommentTok{\#\textgreater{}                       box cutter                            brick }
\CommentTok{\#\textgreater{}                       0.20822488                       0.03470415 }
\CommentTok{\#\textgreater{}              car, knife and mace                          carjack }
\CommentTok{\#\textgreater{}                       0.01735207                       0.01735207 }
\CommentTok{\#\textgreater{}                            chain                        chain saw }
\CommentTok{\#\textgreater{}                       0.05205622                       0.03470415 }
\CommentTok{\#\textgreater{}                         chainsaw                            chair }
\CommentTok{\#\textgreater{}                       0.01735207                       0.06940829 }
\CommentTok{\#\textgreater{}              claimed to be armed               contractor\textquotesingle{}s level }
\CommentTok{\#\textgreater{}                       0.01735207                       0.01735207 }
\CommentTok{\#\textgreater{}                   cordless drill                         crossbow }
\CommentTok{\#\textgreater{}                       0.01735207                       0.15616866 }
\CommentTok{\#\textgreater{}                          crowbar                        fireworks }
\CommentTok{\#\textgreater{}                       0.06940829                       0.01735207 }
\CommentTok{\#\textgreater{}                         flagpole                       flashlight }
\CommentTok{\#\textgreater{}                       0.01735207                       0.03470415 }
\CommentTok{\#\textgreater{}                      garden tool                      glass shard }
\CommentTok{\#\textgreater{}                       0.03470415                       0.05205622 }
\CommentTok{\#\textgreater{}                          grenade                              gun }
\CommentTok{\#\textgreater{}                       0.01735207                      57.03626583 }
\CommentTok{\#\textgreater{}                      gun and car                    gun and knife }
\CommentTok{\#\textgreater{}                       0.19087281                       0.32968940 }
\CommentTok{\#\textgreater{}                  gun and machete                    gun and sword }
\CommentTok{\#\textgreater{}                       0.01735207                       0.01735207 }
\CommentTok{\#\textgreater{}                  gun and vehicle              guns and explosives }
\CommentTok{\#\textgreater{}                       0.19087281                       0.05205622 }
\CommentTok{\#\textgreater{}                           hammer                       hand torch }
\CommentTok{\#\textgreater{}                       0.27763318                       0.01735207 }
\CommentTok{\#\textgreater{}                          hatchet                  hatchet and gun }
\CommentTok{\#\textgreater{}                       0.19087281                       0.03470415 }
\CommentTok{\#\textgreater{}                         ice pick                incendiary device }
\CommentTok{\#\textgreater{}                       0.01735207                       0.03470415 }
\CommentTok{\#\textgreater{}                            knife                 lawn mower blade }
\CommentTok{\#\textgreater{}                      14.78396668                       0.03470415 }
\CommentTok{\#\textgreater{}                          machete                  machete and gun }
\CommentTok{\#\textgreater{}                       0.83289953                       0.01735207 }
\CommentTok{\#\textgreater{}                     meat cleaver                  metal hand tool }
\CommentTok{\#\textgreater{}                       0.08676037                       0.01735207 }
\CommentTok{\#\textgreater{}                     metal object                       metal pipe }
\CommentTok{\#\textgreater{}                       0.06940829                       0.24292903 }
\CommentTok{\#\textgreater{}                       metal pole                       metal rake }
\CommentTok{\#\textgreater{}                       0.05205622                       0.01735207 }
...
\CommentTok{\#\textgreater{}                       0.03470415                       0.06940829 }
\CommentTok{\#\textgreater{}                    piece of wood                             pipe }
\CommentTok{\#\textgreater{}                       0.08676037                       0.10411244 }
\CommentTok{\#\textgreater{}                        pitchfork                             pole }
\CommentTok{\#\textgreater{}                       0.03470415                       0.03470415 }
\CommentTok{\#\textgreater{}                   pole and knife                             rock }
\CommentTok{\#\textgreater{}                       0.03470415                       0.10411244 }
\CommentTok{\#\textgreater{}                    samurai sword                         scissors }
\CommentTok{\#\textgreater{}                       0.05205622                       0.12146452 }
\CommentTok{\#\textgreater{}                      screwdriver                     sharp object }
\CommentTok{\#\textgreater{}                       0.22557696                       0.20822488 }
\CommentTok{\#\textgreater{}                           shovel                            spear }
\CommentTok{\#\textgreater{}                       0.12146452                       0.03470415 }
\CommentTok{\#\textgreater{}                          stapler              straight edge razor }
\CommentTok{\#\textgreater{}                       0.01735207                       0.06940829 }
\CommentTok{\#\textgreater{}                            sword                            Taser }
\CommentTok{\#\textgreater{}                       0.39909769                       0.46850599 }
\CommentTok{\#\textgreater{}                        tire iron                       toy weapon }
\CommentTok{\#\textgreater{}                       0.03470415                       3.36630227 }
\CommentTok{\#\textgreater{}                          unarmed                     undetermined }
\CommentTok{\#\textgreater{}                       6.35085893                       2.93250043 }
\CommentTok{\#\textgreater{}                   unknown weapon                          vehicle }
\CommentTok{\#\textgreater{}                       1.42287003                       2.88044421 }
...
\CommentTok{\#\textgreater{}                       0.01735207}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{temp \textless{}{-}}\StringTok{ }\KeywordTok{table}\NormalTok{(shootings}\OperatorTok{$}\NormalTok{armed) }\OperatorTok{/}\StringTok{ }\KeywordTok{nrow}\NormalTok{(shootings) }\OperatorTok{*}\StringTok{ }\DecValTok{100}
\NormalTok{temp \textless{}{-}}\StringTok{ }\KeywordTok{sort}\NormalTok{(temp, }\DataTypeTok{decreasing =} \OtherTok{TRUE}\NormalTok{)}
\NormalTok{temp \textless{}{-}}\StringTok{ }\KeywordTok{round}\NormalTok{(temp, }\DataTypeTok{digits =} \DecValTok{2}\NormalTok{)}
\NormalTok{temp}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{}                              gun                            knife }
\CommentTok{\#\textgreater{}                            57.04                            14.78 }
\CommentTok{\#\textgreater{}                          unarmed                       toy weapon }
\CommentTok{\#\textgreater{}                             6.35                             3.37 }
\CommentTok{\#\textgreater{}                     undetermined                          vehicle }
\CommentTok{\#\textgreater{}                             2.93                             2.88 }
\CommentTok{\#\textgreater{}                   unknown weapon                          machete }
\CommentTok{\#\textgreater{}                             1.42                             0.83 }
\CommentTok{\#\textgreater{}                            Taser                               ax }
\CommentTok{\#\textgreater{}                             0.47                             0.42 }
\CommentTok{\#\textgreater{}                            sword                     baseball bat }
\CommentTok{\#\textgreater{}                             0.40                             0.33 }
\CommentTok{\#\textgreater{}                    gun and knife                           hammer }
\CommentTok{\#\textgreater{}                             0.33                             0.28 }
\CommentTok{\#\textgreater{}                       metal pipe                      screwdriver }
\CommentTok{\#\textgreater{}                             0.24                             0.23 }
\CommentTok{\#\textgreater{}                       box cutter                     sharp object }
\CommentTok{\#\textgreater{}                             0.21                             0.21 }
\CommentTok{\#\textgreater{}                      gun and car                  gun and vehicle }
\CommentTok{\#\textgreater{}                             0.19                             0.19 }
\CommentTok{\#\textgreater{}                          hatchet                         crossbow }
\CommentTok{\#\textgreater{}                             0.19                             0.16 }
\CommentTok{\#\textgreater{}                         scissors                           shovel }
\CommentTok{\#\textgreater{}                             0.12                             0.12 }
\CommentTok{\#\textgreater{}                            baton                             pipe }
\CommentTok{\#\textgreater{}                             0.10                             0.10 }
\CommentTok{\#\textgreater{}                             rock                           BB gun }
\CommentTok{\#\textgreater{}                             0.10                             0.09 }
\CommentTok{\#\textgreater{}                     blunt object                     meat cleaver }
\CommentTok{\#\textgreater{}                             0.09                             0.09 }
\CommentTok{\#\textgreater{}                    piece of wood                            chair }
\CommentTok{\#\textgreater{}                             0.09                             0.07 }
\CommentTok{\#\textgreater{}                          crowbar                     metal object }
\CommentTok{\#\textgreater{}                             0.07                             0.07 }
\CommentTok{\#\textgreater{}                         pick{-}axe              straight edge razor }
\CommentTok{\#\textgreater{}                             0.07                             0.07 }
\CommentTok{\#\textgreater{}                  vehicle and gun                   Airsoft pistol }
\CommentTok{\#\textgreater{}                             0.07                             0.05 }
\CommentTok{\#\textgreater{}                      beer bottle                            chain }
\CommentTok{\#\textgreater{}                             0.05                             0.05 }
\CommentTok{\#\textgreater{}                      glass shard              guns and explosives }
\CommentTok{\#\textgreater{}                             0.05                             0.05 }
\CommentTok{\#\textgreater{}                       metal pole                      metal stick }
\CommentTok{\#\textgreater{}                             0.05                             0.05 }
...
\CommentTok{\#\textgreater{}                             0.03                             0.03 }
\CommentTok{\#\textgreater{}                        tire iron                  air conditioner }
...
\CommentTok{\#\textgreater{}                             0.02                             0.02 }
\CommentTok{\#\textgreater{}                          grenade                  gun and machete }
\CommentTok{\#\textgreater{}                             0.02                             0.02 }
...
\CommentTok{\#\textgreater{}  4.372723 95.592573}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{temp \textless{}{-}}\StringTok{ }\KeywordTok{table}\NormalTok{(shootings}\OperatorTok{$}\NormalTok{race) }\OperatorTok{/}\StringTok{ }\KeywordTok{nrow}\NormalTok{(shootings) }\OperatorTok{*}\StringTok{ }\DecValTok{100}
\NormalTok{temp \textless{}{-}}\StringTok{ }\KeywordTok{sort}\NormalTok{(temp)}
\NormalTok{temp \textless{}{-}}\StringTok{ }\KeywordTok{round}\NormalTok{(temp, }\DataTypeTok{digits =} \DecValTok{2}\NormalTok{)}
\NormalTok{temp}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{}     O     N     A     H     B     W }
\CommentTok{\#\textgreater{}  0.82  1.41  1.65 16.48 23.53 45.15}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{} Warning: Removed 265 rows containing non{-}finite values (stat\_bin).}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{} Warning: Removed 265 rows containing non{-}finite values (stat\_density).}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{} Warning: Removed 265 rows containing non{-}finite values (stat\_count).}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{}   95 1356  950   81   47 2602}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{}    O    N    A    H    B    W }
\CommentTok{\#\textgreater{}   47   81   95  950 1356 2602}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{} 2602 1356  950   95   81   47}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{shootings}\OperatorTok{$}\NormalTok{race \textless{}{-}}\StringTok{ }\KeywordTok{factor}\NormalTok{(shootings}\OperatorTok{$}\NormalTok{race,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{shootings}\OperatorTok{$}\NormalTok{race \textless{}{-}}\StringTok{ }\KeywordTok{as.character}\NormalTok{(shootings}\OperatorTok{$}\NormalTok{race)}
\NormalTok{shootings}\OperatorTok{$}\NormalTok{race[}\KeywordTok{is.na}\NormalTok{(shootings}\OperatorTok{$}\NormalTok{race)] \textless{}{-}}\StringTok{ "Unknown"}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{shootings}\OperatorTok{$}\NormalTok{race[shootings}\OperatorTok{$}\NormalTok{race }\OperatorTok{==}\StringTok{ "O"}\NormalTok{] \textless{}{-}}\StringTok{ "Other"}
\NormalTok{shootings}\OperatorTok{$}\NormalTok{race[shootings}\OperatorTok{$}\NormalTok{race }\OperatorTok{==}\StringTok{ "N"}\NormalTok{] \textless{}{-}}\StringTok{ "Native American"}
\NormalTok{shootings}\OperatorTok{$}\NormalTok{race[shootings}\OperatorTok{$}\NormalTok{race }\OperatorTok{==}\StringTok{ "A"}\NormalTok{] \textless{}{-}}\StringTok{ "Asian"}
\NormalTok{shootings}\OperatorTok{$}\NormalTok{race[shootings}\OperatorTok{$}\NormalTok{race }\OperatorTok{==}\StringTok{ "H"}\NormalTok{] \textless{}{-}}\StringTok{ "Hispanic"}
\NormalTok{shootings}\OperatorTok{$}\NormalTok{race[shootings}\OperatorTok{$}\NormalTok{race }\OperatorTok{==}\StringTok{ "B"}\NormalTok{] \textless{}{-}}\StringTok{ "Black"}
\NormalTok{shootings}\OperatorTok{$}\NormalTok{race[shootings}\OperatorTok{$}\NormalTok{race }\OperatorTok{==}\StringTok{ "W"}\NormalTok{] \textless{}{-}}\StringTok{ "White"}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{shootings}\OperatorTok{$}\NormalTok{dummy \textless{}{-}}\StringTok{ }\DecValTok{1}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{shootings}\OperatorTok{$}\NormalTok{month\_year \textless{}{-}}\StringTok{ }\KeywordTok{floor\_date}\NormalTok{(shootings}\OperatorTok{$}\NormalTok{date, }\DataTypeTok{unit =} \StringTok{"month"}\NormalTok{)}
\NormalTok{shootings}\OperatorTok{$}\NormalTok{year \textless{}{-}}\StringTok{ }\KeywordTok{year}\NormalTok{(shootings}\OperatorTok{$}\NormalTok{date)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{suicide\_agg}\OperatorTok{$}\NormalTok{number\_suicides \textless{}{-}}\StringTok{ }\DecValTok{1}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sf\_neighborhoods\_suicide}\OperatorTok{$}\NormalTok{number\_suicides[}\KeywordTok{is.na}\NormalTok{(sf\_neighborhoods\_suicide}\OperatorTok{$}\NormalTok{number\_suicides)] \textless{}{-}}\StringTok{ }\DecValTok{0}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{addTiles}\NormalTok{(}\StringTok{\textquotesingle{}http://\{s\}.tile.openstreetmap.org/\{z\}/\{x\}/\{y\}.png\textquotesingle{}}\NormalTok{, }
           \DataTypeTok{attribution =} \StringTok{\textquotesingle{}\&copy; \textless{}a href="http://openstreetmap.org"\textgreater{}}
\StringTok{                OpenStreetMap\textless{}/a\textgreater{} contributors\textquotesingle{}}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pal \textless{}{-}}\StringTok{ }\KeywordTok{colorNumeric}\NormalTok{(}\StringTok{"OrRd"}\NormalTok{, sf\_neighborhoods\_suicide}\OperatorTok{$}\NormalTok{number\_suicides)}
\KeywordTok{leaflet}\NormalTok{()  }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{addTiles}\NormalTok{(}\StringTok{\textquotesingle{}http://\{s\}.tile.openstreetmap.org/\{z\}/\{x\}/\{y\}.png\textquotesingle{}}\NormalTok{, }
           \DataTypeTok{attribution =} \StringTok{\textquotesingle{}\&copy; \textless{}a href="http://openstreetmap.org"\textgreater{}}
\StringTok{                OpenStreetMap\textless{}/a\textgreater{} contributors\textquotesingle{}}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}
...
\StringTok{  }\KeywordTok{addPolygons}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ sf\_neighborhoods\_suicide}\OperatorTok{$}\NormalTok{geometry,}
              ...
              \DataTypeTok{popup =} \KeywordTok{paste0}\NormalTok{(}\StringTok{"Neighborhood: "}\NormalTok{, sf\_neighborhoods\_suicide}\OperatorTok{$}\NormalTok{nhood,}
                             ...
                             \StringTok{"Number of Suicides: "}\NormalTok{, sf\_neighborhoods\_suicide}\OperatorTok{$}\NormalTok{number\_suicides),}
              \DataTypeTok{fillColor =} \KeywordTok{pal}\NormalTok{(sf\_neighborhoods\_suicide}\OperatorTok{$}\NormalTok{number\_suicides),}
              \DataTypeTok{fillOpacity =} \DecValTok{1}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{scrape\_pdf \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(list\_of\_tables, table\_number, number\_columns, column\_names) \{}
\NormalTok{  data \textless{}{-}}\StringTok{ }\NormalTok{list\_of\_tables[table\_number]}
\NormalTok{  data \textless{}{-}}\StringTok{ }\KeywordTok{trimws}\NormalTok{(data)}
\NormalTok{  data \textless{}{-}}\StringTok{ }\KeywordTok{strsplit}\NormalTok{(data, }\StringTok{"}\CharTok{\textbackslash{}r\textbackslash{}n}\StringTok{"}\NormalTok{)}
\NormalTok{  data \textless{}{-}}\StringTok{ }\NormalTok{data[[}\DecValTok{1}\NormalTok{]]}
\NormalTok{  data \textless{}{-}}\StringTok{ }\NormalTok{data[}\KeywordTok{grep}\NormalTok{(}\StringTok{"Miami"}\NormalTok{, data)}\OperatorTok{:}\KeywordTok{grep}\NormalTok{(}\StringTok{"Nationwide Total"}\NormalTok{, data)]}
\NormalTok{  data \textless{}{-}}\StringTok{ }\KeywordTok{str\_split\_fixed}\NormalTok{(data, }\StringTok{" \{2,\}"}\NormalTok{, number\_columns)}
\NormalTok{  data \textless{}{-}}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(data, }\DataTypeTok{stringsAsFactors =} \OtherTok{FALSE}\NormalTok{)}
  \KeywordTok{names}\NormalTok{(data) \textless{}{-}}\StringTok{ }\NormalTok{column\_names}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{table\_}\DecValTok{1}\NormalTok{ \textless{}{-}}\StringTok{ }\KeywordTok{scrape\_pdf}\NormalTok{(}\DataTypeTok{list\_of\_tables =}\NormalTok{ border\_patrol,}
                      ...
                      \DataTypeTok{column\_names =} \KeywordTok{c}\NormalTok{(}\StringTok{"sector"}\NormalTok{,}
                                       ...
                                       \StringTok{"rescues"}\NormalTok{,}
                                       \StringTok{"deaths"}\NormalTok{))}
\NormalTok{table\_}\DecValTok{2}\NormalTok{ \textless{}{-}}\StringTok{ }\KeywordTok{scrape\_pdf}\NormalTok{(}\DataTypeTok{list\_of\_tables =}\NormalTok{ border\_patrol,}
                      ...
                      \DataTypeTok{column\_names =} \KeywordTok{c}\NormalTok{(}\StringTok{"sector"}\NormalTok{,}
                                       ...
                                       \StringTok{"total\_apprehensions"}\NormalTok{))}
\NormalTok{table\_}\DecValTok{3}\NormalTok{ \textless{}{-}}\StringTok{ }\KeywordTok{scrape\_pdf}\NormalTok{(}\DataTypeTok{list\_of\_tables =}\NormalTok{ border\_patrol,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{table\_}\DecValTok{1}\OperatorTok{$}\NormalTok{sector \textless{}{-}}\StringTok{ }\KeywordTok{gsub}\NormalTok{(}\StringTok{"}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{*"}\NormalTok{, }\StringTok{""}\NormalTok{, table\_}\DecValTok{1}\OperatorTok{$}\NormalTok{sector)}
\NormalTok{table\_}\DecValTok{1}\OperatorTok{$}\NormalTok{sector \textless{}{-}}\StringTok{ }\KeywordTok{trimws}\NormalTok{(table\_}\DecValTok{1}\OperatorTok{$}\NormalTok{sector)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{data \textless{}{-}}\StringTok{ }\NormalTok{data[data}\OperatorTok{$}\NormalTok{county }\OperatorTok{!=}\StringTok{ ""}\NormalTok{, ]}
\KeywordTok{head}\NormalTok{(data)}
\CommentTok{\#\textgreater{}      county pregnant\_females\_booked}
\CommentTok{\#\textgreater{} 1  Anderson                       0}
\CommentTok{\#\textgreater{} 2   Andrews                       1}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{data \textless{}{-}}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{county =} \KeywordTok{c}\NormalTok{(data[, }\KeywordTok{c}\NormalTok{(}\OtherTok{TRUE}\NormalTok{, }\OtherTok{FALSE}\NormalTok{)]),}
...
\CommentTok{\#\textgreater{} Warning: package \textquotesingle{}jsonlite\textquotesingle{} was built under R version 4.0.3}
...
\CommentTok{\#\textgreater{}                       address location.x location.y score}
\CommentTok{\#\textgreater{} 1 75 9th Ave, New York, 10011  {-}74.00466   40.74222   100}
\CommentTok{\#\textgreater{}         attributes.Match\_addr attributes.Addr\_type extent.xmin extent.ymin}
\CommentTok{\#\textgreater{} 1 75 9th Ave, New York, 10011         PointAddress   {-}74.00566    40.74122}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{address\_coordinates \textless{}{-}}\StringTok{ }\KeywordTok{fromJSON}\NormalTok{(}\StringTok{"https://geocode.arcgis.com/arcgis/rest/services/World/GeocodeServer/findAddressCandidates?f=json\&singleLine=75\%209th\%20Ave,\%20New\%20York,\%20NY\%2010011\&outFields=Match\_addr,Addr\_type"}\NormalTok{)}
...
\begin{Highlighting}[]
\NormalTok{address\_coordinates \textless{}{-}}\StringTok{ }\KeywordTok{fromJSON}\NormalTok{(}\StringTok{"https://geocode.arcgis.com/arcgis/rest/services/World/GeocodeServer/findAddressCandidates?f=json\&singleLine=75\%209th\%20Ave,\%20New\%20York,\%20NY\%2010011\&outFields=Match\_addr,Addr\_type"}\NormalTok{)}
\NormalTok{address\_coordinates \textless{}{-}}\StringTok{ }\NormalTok{address\_coordinates}\OperatorTok{$}\NormalTok{candidates}
\NormalTok{address\_coordinates \textless{}{-}}\StringTok{ }\NormalTok{address\_coordinates[}\DecValTok{1}\NormalTok{, ]}
...
\begin{Highlighting}[]
\NormalTok{geocode\_address \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(address) \{}
\NormalTok{   address \textless{}{-}}\StringTok{ }\KeywordTok{gsub}\NormalTok{(}\StringTok{" "}\NormalTok{, }\StringTok{"\%20"}\NormalTok{, address)}
\NormalTok{   url \textless{}{-}}\StringTok{ }\KeywordTok{paste}\NormalTok{(}\StringTok{"https://geocode.arcgis.com/arcgis/rest/services/World/GeocodeServer/findAddressCandidates?f=json\&singleLine="}\NormalTok{,}
\NormalTok{                address,}
                \StringTok{"\&outFields=Match\_addr,Addr\_type"}\NormalTok{,}
                \DataTypeTok{sep =} \StringTok{""}\NormalTok{)}
\NormalTok{   address\_coordinates \textless{}{-}}\StringTok{ }\KeywordTok{fromJSON}\NormalTok{(url)}
   
\NormalTok{   address\_coordinates \textless{}{-}}\StringTok{ }\NormalTok{address\_coordinates}\OperatorTok{$}\NormalTok{candidates}
\NormalTok{   address\_coordinates \textless{}{-}}\StringTok{ }\NormalTok{address\_coordinates[}\DecValTok{1}\NormalTok{, ]}
\NormalTok{   address\_coordinates \textless{}{-}}\StringTok{ }\NormalTok{address\_coordinates}\OperatorTok{$}\NormalTok{location}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{marijuana}\OperatorTok{$}\NormalTok{Premise\_Address \textless{}{-}}\StringTok{ }\KeywordTok{gsub}\NormalTok{(}\StringTok{" County: SAN FRANCISCO"}\NormalTok{, }\StringTok{""}\NormalTok{, marijuana}\OperatorTok{$}\NormalTok{Premise\_Address)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{}  [1] "License\_Number"               "License\_Type"                }
\CommentTok{\#\textgreater{}  [3] "Business\_Owner"               "Business\_Contact\_Information"}
\CommentTok{\#\textgreater{}  [5] "Business\_Structure"           "Premise\_Address"             }
\CommentTok{\#\textgreater{}  [7] "Status"                       "Issue\_Date"                  }
\CommentTok{\#\textgreater{}  [9] "Expiration\_Date"              "Activities"                  }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{marijuana}\OperatorTok{$}\NormalTok{lon \textless{}{-}}\StringTok{ }\OtherTok{NA}
\NormalTok{marijuana}\OperatorTok{$}\NormalTok{lat \textless{}{-}}\StringTok{ }\OtherTok{NA}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{temp \textless{}{-}}\StringTok{ }\KeywordTok{geocode\_address}\NormalTok{(marijuana}\OperatorTok{$}\NormalTok{Premise\_Address[}\DecValTok{1}\NormalTok{])}
\NormalTok{temp}
\CommentTok{\#\textgreater{}           x        y}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{marijuana}\OperatorTok{$}\NormalTok{lon[}\DecValTok{1}\NormalTok{] \textless{}{-}}\StringTok{ }\NormalTok{temp}\OperatorTok{$}\NormalTok{x}
\NormalTok{marijuana}\OperatorTok{$}\NormalTok{lat[}\DecValTok{1}\NormalTok{] \textless{}{-}}\StringTok{ }\NormalTok{temp}\OperatorTok{$}\NormalTok{y}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{   temp \textless{}{-}}\StringTok{ }\KeywordTok{geocode\_address}\NormalTok{(marijuana}\OperatorTok{$}\NormalTok{Premise\_Address[i])}
\NormalTok{   marijuana}\OperatorTok{$}\NormalTok{lon[i] \textless{}{-}}\StringTok{ }\NormalTok{temp}\OperatorTok{$}\NormalTok{x}
\NormalTok{   marijuana}\OperatorTok{$}\NormalTok{lat[i] \textless{}{-}}\StringTok{ }\NormalTok{temp}\OperatorTok{$}\NormalTok{y}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\chapter*{(PART) Project Management}\label{part-project-management}}
...
\chapter*{(PART) Data}\label{part-data}}
\addcontentsline{toc}{chapter}{(PART) Data}
...
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{}  1960  1961  1962  1963  1964  1965  1966  1967  1968  1969  1970  1971  1972 }
\CommentTok{\#\textgreater{}  8452  8456  7825  8713  9038  9097  9147  9275  9398  9477  9835 10509 11302 }
\CommentTok{\#\textgreater{}  1973  1974  1975  1976  1977  1978  1979  1980  1981  1982  1983  1984  1985 }
\CommentTok{\#\textgreater{} 12002 12510 13516 14518 15230 15770 16176 16413 16614 16792 16913 17037 17267 }
\CommentTok{\#\textgreater{}  1986  1987  1988  1989  1990  1991  1992  1993  1994  1995  1996  1997  1998 }
\CommentTok{\#\textgreater{} 17441 17527 17298 17430 17608 17852 18012 18195 18367 18482 18536 18921 18510 }
\CommentTok{\#\textgreater{}  1999  2000  2001  2002  2003  2004  2005  2006  2007  2008  2009  2010  2011 }
\CommentTok{\#\textgreater{} 18778 19655 19820 20214 20388 20585 20739 21011 21219 21353 21583 21771 21897 }
\CommentTok{\#\textgreater{}  2012  2013  2014  2015  2016  2017 }
\CommentTok{\#\textgreater{} 22049 22202 22332 22524 22645 22784}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{} [1] "AK00101" "AK00101" "AK00101" "AK00101" "AK00101" "AK00101"}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{} 229843   2514   2522   2926   2633   2875   3876   3350   4013   4693   6416 }
\CommentTok{\#\textgreater{}     11     12 }
\CommentTok{\#\textgreater{}  14940 678409}
\end{Highlighting}
\end{Shaded}
