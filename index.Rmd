...
# bookdown::render_book("index.Rmd", "bookdown::pdf_book", output_file = "crimebythenumbers.pdf", output_dir = getwd())
# bookdown::render_book("index.Rmd", "bookdown::epub_book", output_file = "crimebythenumbers.epub", output_dir = getwd())
