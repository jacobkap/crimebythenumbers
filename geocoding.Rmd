...
Above we are saying "how many times do the values "", "withheld", or "Withheld" appear in the column "location". The answer is `r sum(officer_shootings$location %in% c("", "withheld", "Withheld"))` times. 
