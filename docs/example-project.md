...
Before we get into exactly to how use R, we'll go over a brief example of a kind of data project that you'd do in the real world. For this chapter we'll look at FBI homicide data that you can download [here](https://github.com/jacobkap/r4crimz/tree/master/data). The file is called "shr_1976_2020.rds".
