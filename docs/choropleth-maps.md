...
Coordinate Reference System:
  EPSG: 3857 
  proj4string: "+proj=merc +lon_0=0 +lat_ts=0 +x_0=0 +y_0=0 +a=6378137 +b=6378137 +nadgrids=@null +units=m +no_defs"
```
...
Coordinate Reference System:
  No EPSG code
  proj4string: "+proj=merc +lon_0=0 +lat_ts=0 +x_0=0 +y_0=0 +a=6378137 +b=6378137 +nadgrids=@null +units=us-ft +no_defs"
```
...
<img src="choropleth-maps_files/figure-html/unnamed-chunk-15-1.png" width="90%" style="display: block; margin: auto;" />
...
<img src="choropleth-maps_files/figure-html/unnamed-chunk-34-1.png" width="90%" style="display: block; margin: auto;" />
