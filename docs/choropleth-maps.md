...
#> Reading layer `san_francisco_neighborhoods' from data source `C:\Users\jkkap\Dropbox\crimebythenumbers\data\san_francisco_neighborhoods.shp' using driver `ESRI Shapefile'
