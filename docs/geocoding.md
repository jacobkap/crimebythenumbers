...
In Chapter \@ref(Scraping data from PDFs) we got the address of every officer-involved shooting in Philadelphia. To be able to graph where each shooting occurred we need to convert the addresses into geographic coordinates, a process called geocoding. 
...
<img src="geocoding_files/figure-html/unnamed-chunk-36-1.png" width="90%" style="display: block; margin: auto;" />
