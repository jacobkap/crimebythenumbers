...
```r
myd(dates)
#> Error in myd(dates): could not find function "myd"
```
...
```r
ymd_hms(dates)
#> Error in ymd_hms(dates): could not find function "ymd_hms"
```
...
#> Error in month(dates, label = TRUE): could not find function "month"
```
...
#> Error in month(dates, label = TRUE, abbr = FALSE): could not find function "month"
```
...
#> Error in floor_date(dates, unit = "month"): could not find function "floor_date"
```
...
#> Error in floor_date(dates, unit = "year"): could not find function "floor_date"
```
...
#> Error in mdy_hms(chicago$Date): could not find function "mdy_hms"
```
...
#> Error in year(chicago$real_date): could not find function "year"
```


```r
chicago$month <- month(chicago$real_date,label = TRUE, abbr = FALSE)
#> Error in month(chicago$real_date, label = TRUE, abbr = FALSE): could not find function "month"
```


```r
chicago$weekday <- wday(chicago$real_date, label = TRUE, abbr = FALSE)
#> Error in wday(chicago$real_date, label = TRUE, abbr = FALSE): could not find function "wday"
```
