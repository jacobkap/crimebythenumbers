...
\textbf{Jacob Kaplan} is a researcher at the Princeton
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{crimebythenumbers_files/figure-latex/unnamed-chunk-41-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{images/view_example} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=1\textheight,]{crimebythenumbers_files/figure-latex/unnamed-chunk-98-1} \end{center}
...
\caption{\label{tab:unnamed-chunk-119}This is an example table caption}
\centering
...
web page yourself) and want to be sure your scraping code
did the scrape correctly. However, in most cases when
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{crimebythenumbers_files/figure-latex/unnamed-chunk-241-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{crimebythenumbers_files/figure-latex/unnamed-chunk-242-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{crimebythenumbers_files/figure-latex/unnamed-chunk-253-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{crimebythenumbers_files/figure-latex/unnamed-chunk-254-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{crimebythenumbers_files/figure-latex/unnamed-chunk-331-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{crimebythenumbers_files/figure-latex/unnamed-chunk-334-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{crimebythenumbers_files/figure-latex/unnamed-chunk-355-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{crimebythenumbers_files/figure-latex/unnamed-chunk-356-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{crimebythenumbers_files/figure-latex/unnamed-chunk-363-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{crimebythenumbers_files/figure-latex/unnamed-chunk-364-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{crimebythenumbers_files/figure-latex/unnamed-chunk-368-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{crimebythenumbers_files/figure-latex/unnamed-chunk-369-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{crimebythenumbers_files/figure-latex/unnamed-chunk-374-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{crimebythenumbers_files/figure-latex/unnamed-chunk-379-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{crimebythenumbers_files/figure-latex/unnamed-chunk-380-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{crimebythenumbers_files/figure-latex/unnamed-chunk-392-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{crimebythenumbers_files/figure-latex/unnamed-chunk-400-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{crimebythenumbers_files/figure-latex/unnamed-chunk-403-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{crimebythenumbers_files/figure-latex/unnamed-chunk-406-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{crimebythenumbers_files/figure-latex/unnamed-chunk-416-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{crimebythenumbers_files/figure-latex/unnamed-chunk-422-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{crimebythenumbers_files/figure-latex/unnamed-chunk-438-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{crimebythenumbers_files/figure-latex/unnamed-chunk-439-1} \end{center}
...
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(sf)}
\CommentTok{\# Linking to GEOS 3.9.1, GDAL 3.4.3, PROJ 7.2.1; sf\_use\_s2() is TRUE}
\FunctionTok{load}\NormalTok{(}\StringTok{"data/sf\_neighborhoods\_suicide.rda"}\NormalTok{)}
...
\begin{verbatim}
# {html_document}
# <html id="recipeScTemplate_1-0" class="comp no-js taxlevel-5 recipeScTemplate html mntl-html" data-ab="60,99,62,99,84,99,99" data-resource-version="1.11.0" lang="en" data-mantle-resource-version="3.13.509" data-allrecipes-resource-version="1.11.0" data-tracking-container="true">
# [1] <head class="loc head">\n<meta http-equiv="Content-Ty ...
# [2] <body>\n<svg class="mntl-svg-resource is-hidden"><def ...
\end{verbatim}

\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{images/webscraping_read_html} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{crimebythenumbers_files/figure-latex/unnamed-chunk-634-1} \end{center}
