...
The data has 14 variables and covers 5573 shootings. Let's check out some of the variables, first using \texttt{head()} then using \texttt{summary()} and \texttt{table()}.
...
\CommentTok{\#> "2015{-}01{-}02" "2016{-}05{-}29" "2017{-}11{-}03" "2017{-}10{-}27" "2019{-}03{-}30" "2020{-}08{-}18"}
...
\CommentTok{\#>    6.00   27.00   35.00   37.12   46.00   91.00     248}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#>                       0.01794366                       0.01794366 }
\CommentTok{\#>                   Airsoft pistol                               ax }
\CommentTok{\#>                       0.01794366                       0.43064777 }
\CommentTok{\#>                         barstool                     baseball bat }
\CommentTok{\#>                       0.01794366                       0.32298582 }
\CommentTok{\#>          baseball bat and bottle baseball bat and fireplace poker }
\CommentTok{\#>                       0.01794366                       0.01794366 }
\CommentTok{\#>           baseball bat and knife                            baton }
\CommentTok{\#>                       0.01794366                       0.08971828 }
\CommentTok{\#>                          bayonet                           BB gun }
\CommentTok{\#>                       0.01794366                       0.08971828 }
\CommentTok{\#>               BB gun and vehicle                     bean{-}bag gun }
\CommentTok{\#>                       0.01794366                       0.01794366 }
\CommentTok{\#>                      beer bottle                     blunt object }
\CommentTok{\#>                       0.05383097                       0.08971828 }
\CommentTok{\#>                           bottle                    bow and arrow }
\CommentTok{\#>                       0.01794366                       0.01794366 }
\CommentTok{\#>                       box cutter                            brick }
\CommentTok{\#>                       0.21532388                       0.03588731 }
\CommentTok{\#>              car, knife and mace                          carjack }
\CommentTok{\#>                       0.01794366                       0.01794366 }
\CommentTok{\#>                            chain                        chain saw }
\CommentTok{\#>                       0.05383097                       0.03588731 }
\CommentTok{\#>                         chainsaw                            chair }
\CommentTok{\#>                       0.01794366                       0.07177463 }
\CommentTok{\#>              claimed to be armed               contractor\textquotesingle{}s level }
\CommentTok{\#>                       0.01794366                       0.01794366 }
\CommentTok{\#>                   cordless drill                         crossbow }
\CommentTok{\#>                       0.01794366                       0.16149291 }
\CommentTok{\#>                          crowbar                        fireworks }
\CommentTok{\#>                       0.07177463                       0.01794366 }
\CommentTok{\#>                         flagpole                       flashlight }
\CommentTok{\#>                       0.01794366                       0.03588731 }
\CommentTok{\#>                      garden tool                      glass shard }
\CommentTok{\#>                       0.03588731                       0.05383097 }
\CommentTok{\#>                          grenade                              gun }
\CommentTok{\#>                       0.01794366                      56.64812489 }
\CommentTok{\#>                      gun and car                    gun and knife }
\CommentTok{\#>                       0.19738023                       0.32298582 }
\CommentTok{\#>                    gun and sword                  gun and vehicle }
\CommentTok{\#>                       0.01794366                       0.19738023 }
\CommentTok{\#>              guns and explosives                           hammer }
\CommentTok{\#>                       0.05383097                       0.28709851 }
\CommentTok{\#>                       hand torch                          hatchet }
\CommentTok{\#>                       0.01794366                       0.19738023 }
\CommentTok{\#>                  hatchet and gun                         ice pick }
\CommentTok{\#>                       0.03588731                       0.01794366 }
\CommentTok{\#>                incendiary device                            knife }
\CommentTok{\#>                       0.03588731                      14.76762964 }
\CommentTok{\#>                 lawn mower blade                          machete }
\CommentTok{\#>                       0.03588731                       0.84335188 }
\CommentTok{\#>                  machete and gun                     meat cleaver }
\CommentTok{\#>                       0.01794366                       0.08971828 }
\CommentTok{\#>                  metal hand tool                     metal object }
\CommentTok{\#>                       0.01794366                       0.07177463 }
\CommentTok{\#>                       metal pipe                       metal pole }
\CommentTok{\#>                       0.25121120                       0.05383097 }
\CommentTok{\#>                       metal rake                      metal stick }
\CommentTok{\#>                       0.01794366                       0.05383097 }
\CommentTok{\#>                       motorcycle                         nail gun }
\CommentTok{\#>                       0.01794366                       0.01794366 }
\CommentTok{\#>                              oar                       pellet gun }
\CommentTok{\#>                       0.01794366                       0.05383097 }
\CommentTok{\#>                              pen                     pepper spray }
\CommentTok{\#>                       0.01794366                       0.01794366 }
\CommentTok{\#>                         pick{-}axe                    piece of wood }
\CommentTok{\#>                       0.07177463                       0.08971828 }
\CommentTok{\#>                             pipe                        pitchfork }
\CommentTok{\#>                       0.10766194                       0.03588731 }
\CommentTok{\#>                             pole                   pole and knife }
\CommentTok{\#>                       0.03588731                       0.03588731 }
\CommentTok{\#>                             rock                    samurai sword }
\CommentTok{\#>                       0.10766194                       0.05383097 }
\CommentTok{\#>                         scissors                      screwdriver }
\CommentTok{\#>                       0.12560560                       0.23326754 }
\CommentTok{\#>                     sharp object                           shovel }
\CommentTok{\#>                       0.23326754                       0.10766194 }
\CommentTok{\#>                            spear                          stapler }
\CommentTok{\#>                       0.01794366                       0.01794366 }
\CommentTok{\#>              straight edge razor                            sword }
\CommentTok{\#>                       0.07177463                       0.41270411 }
\CommentTok{\#>                            Taser                        tire iron }
\CommentTok{\#>                       0.46653508                       0.01794366 }
\CommentTok{\#>                       toy weapon                          unarmed }
\CommentTok{\#>                       3.46312579                       6.38794186 }
\CommentTok{\#>                     undetermined                   unknown weapon }
\CommentTok{\#>                       3.03247802                       1.41754890 }
\CommentTok{\#>                          vehicle                  vehicle and gun }
\CommentTok{\#>                       2.85304145                       0.07177463 }
\CommentTok{\#>              vehicle and machete                    walking stick }
\CommentTok{\#>                       0.01794366                       0.01794366 }
\CommentTok{\#>                       wasp spray                           wrench }
\CommentTok{\#>                       0.01794366                       0.01794366}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#>                             0.02                             0.02 }
\CommentTok{\#>                     bean{-}bag gun                           bottle }
\CommentTok{\#>                             0.02                             0.02 }
\CommentTok{\#>                    bow and arrow              car, knife and mace }
\CommentTok{\#>                             0.02                             0.02 }
\CommentTok{\#>                          carjack                         chainsaw }
\CommentTok{\#>                             0.02                             0.02 }
\CommentTok{\#>              claimed to be armed               contractor\textquotesingle{}s level }
\CommentTok{\#>                             0.02                             0.02 }
\CommentTok{\#>                   cordless drill                        fireworks }
\CommentTok{\#>                             0.02                             0.02 }
\CommentTok{\#>                         flagpole                          grenade }
\CommentTok{\#>                             0.02                             0.02 }
\CommentTok{\#>                    gun and sword                       hand torch }
\CommentTok{\#>                             0.02                             0.02 }
\CommentTok{\#>                         ice pick                  machete and gun }
\CommentTok{\#>                             0.02                             0.02 }
\CommentTok{\#>                  metal hand tool                       metal rake }
\CommentTok{\#>                             0.02                             0.02 }
\CommentTok{\#>                       motorcycle                         nail gun }
\CommentTok{\#>                             0.02                             0.02 }
\CommentTok{\#>                              oar                              pen }
\CommentTok{\#>                             0.02                             0.02 }
\CommentTok{\#>                     pepper spray                            spear }
\CommentTok{\#>                             0.02                             0.02 }
\CommentTok{\#>                          stapler                        tire iron }
\CommentTok{\#>                             0.02                             0.02 }
\CommentTok{\#>              vehicle and machete                    walking stick }
\CommentTok{\#>                             0.02                             0.02 }
\CommentTok{\#>                       wasp spray                           wrench }
...
\CommentTok{\#>  0.86  1.40  1.69 16.45 23.60 45.27}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#> Warning: Removed 248 rows containing non{-}finite values (stat\_bin).}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#> Warning: Removed 248 rows containing non{-}finite values (stat\_density).}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#> Warning: Removed 248 rows containing non{-}finite values (stat\_count).}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#>   94 1315  917   78   48 2523}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#> }
\CommentTok{\#>    O    N    A    H    B    W }
\CommentTok{\#>   48   78   94  917 1315 2523}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#> 2523 1315  917   94   78   48}
\end{Highlighting}
\end{Shaded}
