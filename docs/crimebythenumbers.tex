...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{images/leaflet_map5} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{images/leaflet_map6} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{images/leaflet_map7} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{images/leaflet_map8} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{images/leaflet_map9} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{images/leaflet_map10} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{images/leaflet_map11} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{images/leaflet_map12} \end{center}
...
(such as this book's print version), it'll instead be so
long that it may extend off the page. There are a lot of
features in RStudio that make it easy to work with data like
this. In cases where you are presenting the data outside of
RStudio, such as making an R Markdown document, it is
important to check that the results look right in every
format you are making (e.g.~Word, HTML, PDF).
...
\NormalTok{example}
\CommentTok{\#\textgreater{}                               address     lat      long}
\CommentTok{\#\textgreater{} 1 750 Race St. Philadelphia, PA 19106 39.9548 {-}75.15142}
\CommentTok{\#\textgreater{}    place\_id}
\CommentTok{\#\textgreater{} 1 288259524}
...
\CommentTok{\#\textgreater{} Query completed in: 18.5 seconds}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics[width=1\linewidth,height=0.45\textheight,]{crimebythenumbers_files/figure-latex/unnamed-chunk-630-1} \end{center}
