...
#>    6.00   27.00   35.00   37.13   46.00   91.00     238
```
...
#> 
#>     O     N     A     H     B     W 
#>  0.88  1.42  1.72 16.62 23.78 45.63
```
...
ggplot(shootings, aes(x = age)) + 
  stat_count()
#> Warning: Removed 238 rows containing non-finite values (stat_count).
```
